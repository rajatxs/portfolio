import { Code, Code2, Cpu, Database, Globe, Layout, Mail, MapPin, Smartphone, Terminal } from 'lucide-react';
...
export default function App() {
	const skills = {
		frontend: ['React.js', 'Next.js', 'Vue.js', 'Nuxt.js', 'Angular', 'TypeScript', 'Tailwind CSS', 'Shadcn UI', 'Bootstrap', 'HTML5', 'CSS3', 'JavaScript'],
		backend: ['Node.js', 'Fastify.js', 'Express.js', 'Koa.js', 'Go', 'PHP', 'REST APIs', 'WebSockets', 'Vercel AI SDK'],
		infrastructure: ['PostgreSQL', 'MongoDB', 'MySQL', 'Redis', 'Apache Cassandra', 'Docker', 'Podman', 'AWS (EC2, S3, Lambda, SQS)', 'GCP'],
		mobile: ['React Native', 'Expo', 'Ionic', 'Capacitor'],
		ai: ['OpenAI Codex', 'Gemini CLI', 'Ollama', 'Tavily API', 'n8n', 'Playwright'],
	};
	...
	const experience = [
		{
			...
			location: 'Remote',
			description:
				'Building real-time healthcare communication platforms. Focused on scalable frontend systems, real-time video conferencing infrastructure, and cross-platform UX.',
			tech: ['React', 'TypeScript', 'React Native', 'WebRTC', 'Node.js', 'Tailwind CSS'],
		},
		{
			...
			description:
				'Developed IoT monitoring applications and data visualization dashboards. Deployed production workloads on AWS and improved scalability for high-traffic systems.',
			tech: ['Angular', 'TypeScript', 'Node.js', 'Apache Cassandra', 'AWS', 'Docker'],
		},
		{
			...
			location: 'Ahmedabad, India',
			description: 'Redesigned ERP interfaces and developed REST APIs. Improved system performance and usability for core ERP workflows.',
	...
	const projects = [
		{
			...
			tech: ['React', 'TypeScript', 'Fastify.js', 'PostgreSQL', 'Docker', 'Tavily API'],
		},
		{
			title: 'Forge CLI',
		...
		},
		{
			...
			tech: ['React Native', 'TypeScript', 'Replicate API', 'Cloudinary', 'Firebase'],
		},
		{
			title: 'Digital Cold Chain',
			type: 'Vaccine Monitoring Platform',
			description: 'Real-time dashboard for vaccine logistics using AWS cloud-native infrastructure for queueing, auth, and storage.',
			tech: ['Angular', 'AWS Lambda', 'SQS', 'Redis', 'Cassandra', 'Docker'],
		},
		{
			title: 'Plumsense',
			type: 'Healthcare IoT Management',
			description: 'IoT management software for healthcare device monitoring with Auth0 integration and real-time capabilities.',
			tech: ['Angular', 'Express.js', 'AWS', 'MySQL', 'Auth0'],
		},
		{
			title: 'iamone',
			type: 'Personal Link Platform',
			description: 'Custom personal profile and social sharing platform built with high-performance backend.',
			tech: ['Vue.js', 'Go', 'TypeScript', 'MongoDB', 'Vercel'],
		},
	];

	return (
		<div className="min-h-screen transition-colors duration-300 bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
			{/* Navigation */}
